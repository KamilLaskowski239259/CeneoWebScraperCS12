...
class Product:
    ...
    def __repr__(self):
        return f"Product(product_id: {self.product_id}\nproduct_name: {self.product_name}, opinions=["+", ".join(repr(opinion) for opinion in self.opinions)+f"], stats={self.stats})"
    ...
    def generate_charts(self):
        ...
        recommendations = pd.Series(self.stats['recommendations'], index=self.stats ['recommendaions'].keys())
